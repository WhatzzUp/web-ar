...
docker run --rm -v $(pwd):/src -u $(id -u):$(id -g) emscripten/emsdk:2.0.10 emcmake python3 ./opencv/platforms/js/build_js.py build_js --build_wasm --simd --threads --build_loader --cmake_option="-DOPENCV_EXTRA_MODULES_PATH=./opencv_contrib/modules/"